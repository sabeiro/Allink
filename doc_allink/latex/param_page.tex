...
\begin{DoxyCode}
\textcolor{preprocessor}{#everything is normalized to 1}
Arrow
0.0 0.3 0.0 1.0 3.0
...
1.0 1.0 0.125
0.0 1.0 0.125
Fog #color(3) alpha(1) \(\backslash\)\(\backslash\) dens(1) type(1) from(1) boh(2) to(1)
0.0 1.0 0.0 1.0
...
\begin{DoxyCode}
\textcolor{preprocessor}{#Sys size/type}
...
\textcolor{preprocessor}{#Dyn quantities}
...
Temp        1              #temperature
\textcolor{preprocessor}{#Force parameters}
...
Elong       0.2 0.1 0.2    #rest distance \textcolor{keywordflow}{for} the armonic spring
\textcolor{preprocessor}{#boundary}
...
\textcolor{preprocessor}{#tension profile}
TNSlab      60             #number of slabs
TNDim       3              #number of dimensions
TNComp      6              #number of components
TCalcMode   2d             #calculation mode
\textcolor{preprocessor}{#visualisation}
NOut        1000           #number of points \textcolor{keywordflow}{for} visualizing the splines
IfMovie     0              #\textcolor{keywordflow}{if} produces images of the snaphots
IfLine      0              #\textcolor{keywordflow}{if} draws the line
NUpdate     1000           #how many timesteps before redrawing
IfInterp    0              #\textcolor{keywordflow}{if} interpolates the points
\end{DoxyCode}
...
\textcolor{preprocessor}{#visualisation}
NSpline     1000           #number of points \textcolor{keywordflow}{for} visualizing the splines
IfMovie     0              #\textcolor{keywordflow}{if} produces images of the snaphots
IfLine      0              #\textcolor{keywordflow}{if} draws the line
...
CutOff      1              #cutoff distance
Cont        0.             #contact/friction coefficient
Elong       0.2 0.1 0.05    #rest distance \textcolor{keywordflow}{for} the armonic spring
\textcolor{preprocessor}{#boundary}
Rigid x(15. 15. 0.0) a(0.00 0.00 1.00) c(1.0 35.00 2.0 2.2000) s\{cyl\}
\textcolor{preprocessor}{#Rigid x(0.7 0.25 0.5) a(0.00 0.00 1.00) c(0.05 35.00 0.4 2.2000) s\{cyl\}}
